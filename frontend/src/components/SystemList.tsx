    ...
    <div className="flex h-full flex-col bg-bg">
      ...
      <header className="flex items-center gap-3 border-b border-border bg-surface px-6 py-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {/* New system (mine tab only — always in DOM to prevent layout shift) */}
          <div className={tab !== 'mine' || creating ? 'invisible pointer-events-none' : ''}>
                ...
                <div className="flex flex-col gap-2.5">
                  {systems.map((s) => (
                    ...
                    >
                      ...
                      {s.description && (
                        <p className="mb-0 mt-2 font-ui text-[14px] text-fg-body">
                          {s.description}
                        </p>
                      )}
